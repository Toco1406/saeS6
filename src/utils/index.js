...
export const getRegionForName = {
    ...
    "crown-tundra": "Courroneige (Shield & Sword)",
    "original-johto": "Johto (Original)",
    "updated-johto": "Johto (Nouveau)",
    "updated-unova": "Unys (Nouveau)",
    "original-unova": "Unys (Original)",
    "original-alola": "Alola (Original)",
    "original-melemele": "Mele-Mele (Original)",
    "updated-alola": "Alola (Nouveau)",
    "updated-melemele": "l'île de MeleMele (Nouveau)",
    "letsgo-kanto": "Kanto (evoli/pickachu)",
    "original-poni": "l'île de Poni (Original)",
    "updated-poni": "l'île de Poni (Nouveau)",
    "original-sinnoh": "Sinnoh (Original)",
    "extended-sinnoh": "Sinnoh (Nouveau)",
    "isle-of-armor": "Isolarmure",
    "blueberry": "Pokédex Myrtille",
    "conquest-gallery": "Ransei (Pokémon Conquest)",
    "original-akala": "l'île d'Akala (Original)",
    "updated-akala": "l'île d'Akala (Nouveau)",
    "original-ulaula": "l'île d'Ula-Ula (Original)",
    "updated-ulaula": "l'île d'Ula-Ula (Nouveau)",
    "updated-hoenn": "Hoenn (Nouveau)",
    kitakami: "Kitakami",
    kanto: "Kanto",
    johto: "Johto",
    hoenn: "Hoenn (Original)",
    sinnoh: "Sinnoh",
    unova: "Unys",
    kalos: "Kalos",
    alola: "Alola",
